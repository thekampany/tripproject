...
urlpatterns = [
    ...
    path('api/flight-lookup/', views.flight_lookup, name='flight_lookup'),
    ...
    path('dayprogram/<int:dayprogram_id>/vibe/', views.set_day_vibe, name='set_day_vibe'),
    path('dayprogram/<int:dayprogram_id>/add-flight/', views.add_flight, name='add_flight'),
    path('scheduled-item/<int:scheduled_item_id>/refresh-flight/', views.refresh_flight_status, name='refresh_flight_status'),
    ...
    path('checklist/<int:trip_id>/suggest/', views.suggest_checklist_items,    name='suggest_checklist_items'),
    path('checklist/<int:trip_id>/status/',  views.checklist_job_status,       name='checklist_job_status'),
    path('checklist/<int:trip_id>/dismiss/', views.dismiss_checklist_suggestions, name='dismiss_checklist_suggestions'),
    path('checklist/item/<int:item_id>/delete/', views.delete_checklist_item,  name='delete_checklist_item'),
    ...
    path('itineraryidea/<int:pk>/notes/', views.itinerary_notes_list, name='itinerary_notes_list'),
    path('itineraryidea/<int:pk>/notes/add/',         views.add_itinerary_note,    name='add_itinerary_note'),
    path('itineraryidea/notes/<int:note_pk>/delete/',       views.delete_itinerary_note, name='delete_itinerary_note'),
    path('brainstorm/save/', views.save_map_markers, name='save_map_markers'),
    path('brainstorm/<int:idea_pk>/edit/', views.edit_map_markers,   name='edit_map_markers'),
    path('brainstorm/<int:idea_pk>/update/', views.update_map_markers, name='update_map_markers'),
    path('brainstorm/<int:idea_pk>/assign/',  views.assign_markers_view,    name='assign_markers_view'),
    path('brainstorm/<int:idea_pk>/assign/save/', views.assign_markers_to_days, name='assign_markers_to_days'),    path('calculate-route/', views.calculate_route, name='calculate_route'),
    ...
    path('ollamajobs/', views.ollama_job_list, name='ollama_job_list'),
